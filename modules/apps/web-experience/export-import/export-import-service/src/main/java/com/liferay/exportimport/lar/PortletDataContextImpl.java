...
public class PortletDataContextImpl implements PortletDataContext {
	...
	@Override
	public List<String> getImportedFriendlyURL() {
		return _importedFriendlyURL;
	}
	...
	@Override
	public void setImportedFriendlyURL(List<String> importedFriendlyURL) {
		_importedFriendlyURL = importedFriendlyURL;
	}
	...
	private List<String> _importedFriendlyURL;
